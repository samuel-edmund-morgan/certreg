...
<div class="alert-banner" role="alert" aria-live="polite">
  <div class="alert-banner__marquee">
    <div class="alert-banner__track">
      <span class="alert-banner__text">Увага! Невідповідність даних у цьому вікні чи у завантаженому сертифікаті інформації, що міститься у роздрукованому сертифікаті, є ознакою підробки сертифіката.</span>
      <span class="alert-banner__text">Увага! Невідповідність даних у цьому вікні чи у завантаженому сертифікаті інформації, що міститься у роздрукованому сертифікаті, є ознакою підробки сертифіката.</span>
    </div>
  </div>
</div>
